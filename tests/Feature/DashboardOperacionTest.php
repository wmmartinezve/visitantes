...
use App\Filament\Widgets\IndicadoresPorMunicipioWidget;
...
class DashboardOperacionTest extends TestCase
{
    ...
    public function test_metricas_responden_a_filtros_de_fecha(): void
    {
        ...
        $this->assertArrayHasKey('invitados_con_menciones', $kpis);
        $this->assertArrayHasKey('menciones_ayudas_invitados', $kpis);
    ...
    public function test_reporte_completo_incluye_secciones_clave(): void
    {
        ...
        $this->assertArrayHasKey('menciones_por_opcion', $reporte);
        ...
        $this->assertContains('Invitados con menciones', $labels);
